...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lessStyleLess = __webpack_require__(7);

	var _lessStyleLess2 = _interopRequireDefault(_lessStyleLess);

	var _actionsViewActionCreator = __webpack_require__(2);

	var _actionsViewActionCreator2 = _interopRequireDefault(_actionsViewActionCreator);
	...
	var _reactRouterLibHashHistory = __webpack_require__(4);

	_react2['default'].render(_react2['default'].createElement(_reactRouter.Router, { history: _reactRouterLibHashHistory.history, children: _routes2['default'] }), document.body);
	...
	var ViewActionCreator = {
	  getData: function getData() {
	    _dispatcherAppDispatcher2['default'].handleViewAction({
	      actionType: _constantsAppConstants2['default'].GET_DATA
	    });
	  }
	};

	exports['default'] = ViewActionCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsMainReact = __webpack_require__(10);

	var _viewsMainReact2 = _interopRequireDefault(_viewsMainReact);

	var _viewsInsertCoinReact = __webpack_require__(11);

	var _viewsInsertCoinReact2 = _interopRequireDefault(_viewsInsertCoinReact);

	exports['default'] = {
	  path: '/',
	  component: _viewsMainReact2['default'],
	  childRoutes: [{ path: 'insert-coin', component: _viewsInsertCoinReact2['default'] }]
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DOMHistory2 = __webpack_require__(15);

	var _DOMHistory3 = _interopRequireDefault(_DOMHistory2);

	var _NavigationTypes = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, "@import url(http://fonts.googleapis.com/css?family=Press+Start+2P);", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inherits = __webpack_require__(31)['default'];
	...
	var _storesAppStore = __webpack_require__(35);
	...
	var getState = function getState() {
	  return {
	    AppStore: _storesAppStore2['default'].getState()
	  };
	};
	...
	var Main = (function (_Component) {
	  ...
	  _createClass(Main, [{
	    ...
	    value: function componentDidMount() {
	      _storesAppStore2['default'].addChangeListener(this.change);
	    }
	  }, {
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      _storesAppStore2['default'].removeChangeListener(this.change);
	    }
	  }, {
	    key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InsertCoin = (function (_Component) {
	  function InsertCoin() {
	    _classCallCheck(this, InsertCoin);

	    _get(Object.getPrototypeOf(InsertCoin.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _inherits(InsertCoin, _Component);

	  _createClass(InsertCoin, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppConstants = __webpack_require__(14);

	var Dispatcher = __webpack_require__(41).Dispatcher;
	...
	_Object$assign(AppDispatcher, {
	    ...
	    handleRouterAction: function handleRouterAction(path) {
	        var payload = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _History2 = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keymirror = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RoutingUtils = __webpack_require__(64);

	var _PropTypes = __webpack_require__(30);

	var _RouterContextMixin = __webpack_require__(65);

	var _RouterContextMixin2 = _interopRequireDefault(_RouterContextMixin);

	var _ScrollManagementMixin = __webpack_require__(66);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventemitter2 = __webpack_require__(141);
	...
	var Store = (function (_EventEmitter) {
	  ...
	  _createClass(Store, [{
	    ...
	    value: function addChangeListener(callback) {
	      this.on(_constantsAppConstants2['default'].CHANGE_EVENT, callback);
	    }
	  }, {
	    key: 'removeChangeListener',
	    value: function removeChangeListener(callback) {
	      this.removeListener(_constantsAppConstants2['default'].CHANGE_EVENT, callback);
	    }
	  }]);
	 ...
	 * 安排順序
	 */
	store.dispatchToken = _dispatcherAppDispatcher2['default'].register(function eventHandlers(evt) {

	  var action = evt.action;

	  switch (action.actionType) {

	    case _constantsAppConstants2['default'].GET_DATA:
	      if (evt.source === _constantsAppConstants2['default'].SOURCE_VIEW_ACTION) {}

	      if (evt.source === _constantsAppConstants2['default'].SOURCE_SERVER_ACTION) {
	        // Do Server Action
	        State.data = action.data;
	      }

	      store.emit(_constantsAppConstants2['default'].CHANGE_EVENT);
	      break;
	    default:
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "44c1934da69bb16d7e9d858ff3c36073.png"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactFragment = __webpack_require__(81);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsServerActionCreator = __webpack_require__(143);

	var _actionsServerActionCreator2 = _interopRequireDefault(_actionsServerActionCreator);

	exports['default'] = {
	  getData: function getData() {
	    _superagent2['default'].get('http://mtgjson.com/json/FRF-x.json').end(function (err, res) {
	      if (err) throw new Error();
	      _actionsServerActionCreator2['default'].getData(res);
	    });
	  }
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ServerActionCreator = {
	  getData: function getData(data) {
	    _dispatcherAppDispatcher2['default'].handleServerAction({
	      actionType: _constantsAppConstants2['default'].GET_DATA,
	      data: data
	    });
	  }
	...
	exports['default'] = ServerActionCreator;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = module.exports = __webpack_require__(218)({
	  g: global,
	  core: core,
